...
public class CommonMethods extends PageInitializer {
    ...
    public static void openBrowserAndLaunchApplication(){
        ...
        initializePageObject(); // this will initialize all the pages we have in our page  PageInitializer class along with the launching of application

        //To create a log of test cases
